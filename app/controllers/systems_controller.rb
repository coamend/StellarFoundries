class SystemsController < ApplicationController
  ...
  # GET /systems/1.json
  def show
    @primary_star = @system.primary_star
    @secondary_star = @system.secondary_star
    @primary_subsystem = @system.primary_subsystem
    @secondary_subsystem = @system.secondary_subsystem
  ...
  private
    ...
    def system_params
      params.require(:system).permit(:sub_sector_id, :name)
    end
end

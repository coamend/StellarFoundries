...
class SectorsControllerTest < ActionController::TestCase
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post :create, sector: { sectorX: @sector.sectorX, sectorY: @sector.sectorY, universe_id: @sector.universe_id }
    end
  ...
  test "should update sector" do
    patch :update, id: @sector, sector: { sectorX: @sector.sectorX, sectorY: @sector.sectorY, universe_id: @sector.universe_id }
    assert_redirected_to sector_path(assigns(:sector))
  end
